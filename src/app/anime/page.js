...
const Page = () => {
  return <ComingSoon phase="Phase 5" title="Anime hub" blurb="Manga reading, AMV galleries and co-watch rooms are part of a later phase. Nothing here is live yet." alternatives={[{
    href: "/tournaments",
    label: "Tournaments"
  }, {
    href: "/events",
