...
const Page = () => (
  <ComingSoon
    ...
    blurb="Stream overlays, scene configuration and the OBS pipeline are part of the production milestone. The panels are designed but not connected to a live backend."
    alternatives={[
