        ...
        <div className={`${landingStyles.innerLandingShopContainer} ${styles.innerLandingShopContainer}`}>
            ...
            >
                <div className={`${landingStyles.headingContainer} ${styles.headingContainer}`}>
                    <p className={`${landingStyles.subHeadingText} ${styles.subHeadingText}`}>
                        {tt("landing.shop.eyebrow", "V-ENT Shop")}
                    </p>
                    <h2 className={`${landingStyles.headingText} ${styles.headingText}`}>
                        {tt("landing.shop.heading", "Shop Exclusive Gaming and Anime Merch")}
                    </h2>
                </div>
                ...
                <div className={`${landingStyles.descriptionContainer} ${styles.descriptionContainer}`}>
                    <p className={`${landingStyles.descriptionParagraph} ${styles.descriptionParagraph}`}>
                        {tt("landing.shop.body", "Find everything from gaming equipment to anime merchandise in our V-ENT shop. Enjoy exclusive deals, digital items, and fast shipping so you never miss out on the latest gear.")}
                    </p>
            ...
            <div className={styles.landingShopRightContainer}>
                ...
                >
                    <Image
                        src={circledShirt}
                        alt={tt("landing.alt.shirt", "A V-ENT t-shirt, one of the items in the shop")}
                    />
                </div>
            </div>
