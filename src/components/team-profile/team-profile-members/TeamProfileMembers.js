    ...
    <div className={tableStyles.tournamentDetailsParticipantsContainer}>
      <div className={styles.tabsAndDetailsContainer}>
        <div className={tabStyles.borderTabBTNContainer}>
          <button
            className={`${tabStyles.borderTabBTN} ${activeTab === 'members' ? tabStyles.active : ''}`}
          ...
          <button
            className={`${tabStyles.borderTabBTN} ${styles.requestsBTN} ${activeTab === 'requests' ? tabStyles.active : ''}`}
