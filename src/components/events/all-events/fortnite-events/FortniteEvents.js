    ...
    return (
        <div className={allEventsStyles.fifaTournamentsContainer}>
            <div className={allEventsStyles.header}>
                ...
                {!showAll && fortniteEvents.length > 3 && (
                    <button
            ...
            <div className={allEventsStyles.cardsContainer}>
                {fortniteEvents.slice(0, showAll ? fortniteEvents.length : 3).map((event, index) => (
                ...
                {fortniteEvents.length === 0 && (
                    <div className={allEventsStyles.noEventsMessage}>
                        <p>No Fortnite events available at the moment.</p>
                    </div>
                )}
            </div>
        </div>
