...
const ReviewHeaderComponent = ({
  ...
  return <div className={createTournamentStyles.reviewContainer}>
        <div className={createTournamentStyles.reviewHeader}>
            ...
            <div className={createTournamentStyles.completeAndEditContainer}>
                <div className={createTournamentStyles.completionStatusContainer}>
                    <p className={isCompleted ? createTournamentStyles.completeParagraph : createTournamentStyles.inCompleteParagraph}>
                        <span className={`${createTournamentStyles.checkIconSpan} ${isCompleted ? createTournamentStyles.checkIconSpan : createTournamentStyles.unCheckIconSpan}`}>
                ...
                <button className={createTournamentStyles.editBTN} onClick={handleEditClick}>
                    ...
                    {tt("ui.edit.5301", "Edit")}
                </button>
            </div>
        </div>

        {isOpen && <div className={createTournamentStyles.reviewContentOuterContainer}>
