  ...
  return <div className={createTournamentStyles.createSubSectionContainer}>
      <div className={createTournamentStyles.innerCreateSubSectionContainer}>
        ...
        <div className={createTournamentStyles.twoBoxesInRowContainer}>
            <div className={`${createTournamentStyles.halfBoxContainer} ${selectedOption === 'single-elimination' ? createTournamentStyles.activeBox : ''}`} onClick={() => handleOptionClick('single-elimination')}>
            ...
            <div className={`${createTournamentStyles.halfBoxContainer} ${selectedOption === 'swiss-system' ? createTournamentStyles.activeBox : ''}`} onClick={() => handleOptionClick('swiss-system')}>
            ...
            <div className={`${createTournamentStyles.halfBoxContainer} ${selectedOption === 'double-elimination' ? createTournamentStyles.activeBox : ''}`} onClick={() => handleOptionClick('double-elimination')}>
            ...
            <div className={`${createTournamentStyles.halfBoxContainer} ${selectedOption === 'round-robin' ? createTournamentStyles.activeBox : ''}`} onClick={() => handleOptionClick('round-robin')}>
            ...
            <div className={`${createTournamentStyles.halfBoxContainer} ${selectedOption === 'battle-royale' ? createTournamentStyles.activeBox : ''}`} onClick={() => handleOptionClick('battle-royale')}>
