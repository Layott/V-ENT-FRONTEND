...
const UserProfileAchievements = () => {
  ...
  return <div className={`${profileStyles.achievementsContainer} ${profileStyles.middleLayerColor}`} style={{
    position: 'relative'
  }}>
        ...
        <div className={profileStyles.achievementsHeader}>
          ...
          <button className={profileStyles.seeMoreBTN} onClick={handleSeeMoreAndLess} disabled>
