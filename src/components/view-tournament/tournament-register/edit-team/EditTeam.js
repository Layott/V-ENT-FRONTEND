...
const EditTeamRosterModal = ({ isOpen, onClose, onBack, onProceed, selectedTeam }) => {
      ...
      <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
        <div className={styles.modalHeader}>
          <div className={styles.headerLeft}>
            ...
            <h2 className={styles.modalTitle}>Edit Team Roster</h2>
          </div>
        ...
        {showNotification && (
          <div className={styles.notification}>
            <div className={styles.notificationContent}>
              ...
              <span>This edit will only be applied to this tournament.</span>
            </div>
          ...
          <div className={styles.teamHeader}>
            <div className={styles.teamInfo}>
              ...
              <div className={styles.teamDetails}>
                <h3 className={styles.teamName}>{selectedTeam?.name || "Kill Streak Team"}</h3>
          ...
          {removedMembers.length > 0 && (
            <div className={styles.membersSection}>
              <div className={styles.sectionHeader}>
                ...
                <h4 className={styles.sectionTitle}>Removed members</h4>
              </div>
